...
export default function PreviewAutoClipModal({
    ...
    const handleToggleStatus = async () => {
        ...
        try {
            const newStatus = currentClip.status === 'published' ? 'draft' : 'published'
                ...
                <View className="px-4">
                    ...
                    <View className="flex-row mt-4">
                        <TouchableOpacity
                            ...
                            className={`bg-black/50 p-2 px-4 rounded-full mr-3 flex-row items-center ${isStatusLoading ? 'opacity-50' : ''}`}
                        >
                            <FontAwesome
                            ...
                            <Text className="text-white ml-2">
                                {isStatusLoading ? 'Updating...' : currentClip.status === 'published' ? 'Published' : 'Draft'}
                            </Text>
                        </TouchableOpacity>
