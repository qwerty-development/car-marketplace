...
const CategorySelector: React.FC<CategorySelectorProps> = ({ selectedCategories, onCategoryPress }) => {
        ...
        {categories.map((category) => (
          <TouchableOpacity
            ...
            style={[
              ...
              selectedCategories.includes(category.name) && styles.selectedButton,
          ...
          >
            <Image
              ...
              style={[
                ...
                isDarkMode && { tintColor: selectedCategories.includes(category.name) ? '#D55004' : '#FFFFFF' },
                selectedCategories.includes(category.name) && !isDarkMode && { tintColor: '#D55004' }
              ]}
            />
            <Text
              style={[
                styles.categoryText,
                { color: isDarkMode ? '#FFFFFF' : '#000000' },
                selectedCategories.includes(category.name) && styles.selectedText
              ]}
            >
              {category.name}
            </Text>
