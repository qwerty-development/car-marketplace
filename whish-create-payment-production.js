...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const successRedirect = SUCCESS_REDIRECT_URL;
    const failureRedirect = FAILURE_REDIRECT_URL;
    const priceMonthly = PRICE_MONTHLY_USD;
    const priceYearly = PRICE_YEARLY_USD;
    ...
    if (supabaseUrl && supabaseKey) {
      ...
      // Try to log a pending row (ignore failures silently)
