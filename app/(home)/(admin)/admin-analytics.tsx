...
export default function AdminAnalyticsDashboard() {
	...
	const pieChartColors: any = {
		...
		Classic: '#5C677B', // A deep, muted blue, suggesting tradition and complementing 'night'
		Custom: '#7B5154' // A dark, muted burgundy, unique but not overwhelming, working well with 'ed' accents
	}
