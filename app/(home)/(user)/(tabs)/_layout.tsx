    ...
    <Tabs
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ color, size, focused }) => {
          ...
          else if (route.name === 'dealerships') iconName = focused ? 'business' : 'business-outline'
            ...
            return (
              <View
                style={{
                  ...
                  transform: [{ translateY: -15 }], // Adjusted position
                }}>
          ...
          return (
            <View style={{ 
              height: 55, // Match tabBarItemStyle height
              justifyContent: 'center',
              alignItems: 'center',
            }}>
              <Ionicons 
