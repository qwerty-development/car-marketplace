...
export default function SalesHistoryPage() {
  ...
  const renderSaleItem = ({ item }: { item: SaleRecord }) => (
    <TouchableOpacity style={[styles.saleItem, isDarkMode && styles.darkSaleItem]}>
      ...
      <View style={styles.saleItemFooter}>
        <FontAwesome name="calendar" size={14} color={isDarkMode ? '#BBBBBB' : '#666666'} />
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.container}>
          <View style={styles.header}>
            <Text style={[styles.title, isDarkMode && styles.darkText]}>Sales History</Text>
