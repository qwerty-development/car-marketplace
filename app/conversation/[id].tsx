...
export default function ConversationDeepLinkHandler() {
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: isDarkMode ? '#000' : '#fff' }}>
      ...
      <Text style={{ marginTop: 20, color: isDarkMode ? '#fff' : '#000' }}>{t('chat.redirecting', 'Redirecting to conversation...')}</Text>
    </View>
  );
}
